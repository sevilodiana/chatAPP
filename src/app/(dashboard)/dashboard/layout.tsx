    ...
    <div className="w-full flex h-screen">
      ...
      <div className="hidden md:flex h-full w-full max-w-xs grow flex-col gap-y-5 overflow-y-auto border-r border-gray-200 bg-white px-6">
        <Link href="/dashboard" className="flex h-16 shrink-0 items-center">
          <Image priority src={logo} alt="page logo" className="h-10 w-auto" />
        </Link>
        ...
        <nav className="flex flex-1 flex-col">
          <ul role="list" className="flex flex-1 flex-col gap-y-7">
            ...
            <li className="-mx-6 mt-auto flex items-center">
              <div className="flex flex-1 items-center gap-x-4 px-6 py-3 text-sm font-semibold leading-6 text-petroleum">
                ...
                <div className="flex flex-col">
                  ...
                  <span
                    className="text-xs text-petroleum-light"
                    aria-hidden="true"
                  >
                    {session.user.email}
                  </span>
